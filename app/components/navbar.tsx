...
export default function Navbar() {
  ...
  return (
    <nav className="bg-black/90 border-b border-gray-800 sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4 lg:space-x-6 text-sm">
            <Link href="/" className="text-white hover:text-blue-400 transition-colors duration-200 font-medium">
              Home
            </Link>
            <Link href="/pages/services" className="text-white hover:text-pink-400 transition-colors duration-200 font-medium">
              Services
            </Link>
            <Link href="/pages/contact" className="text-white hover:text-yellow-400 transition-colors duration-200 font-medium">
              Contact
            </Link>
            <Link href="/pages/community-resources" className="text-white hover:text-purple-400 transition-colors duration-200 font-medium">
              Community Resources
            </Link>
            <Link href="/pages/gallery" className="text-white hover:text-cyan-400 transition-colors duration-200 font-medium">
              Gallery
            </Link>
            <Link href="/pages/start-your-own-podcast" className="text-white hover:text-orange-400 transition-colors duration-200 font-medium">
